...
def run_sim():
    ...
    bit_width = 16
    fs = 44100
    dut = StaticVocoder(start_freq=100, end_freq=2e3, num_channels=4, fs=fs, sample_width=bit_width)
    ...
    wavfile.write("amen_4_ch.wav", rate=fs, data=np.array(output_samples))
