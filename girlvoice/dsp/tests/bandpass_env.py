...
def run_sim():
    ...
    m.submodules.bandpass = bandpass = BandpassIIR(center_freq=1e3, passband_width=500, filter_order=1, sample_width=bit_width, fs=fs, mult_slice=mult)
    m.submodules.env = envelope = EnvelopeFollower(bit_width, fs, attack_halflife=0.1, decay_halflife=25, mult_slice=mult)
