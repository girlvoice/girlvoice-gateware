...
class LIFCLEVNPlatform(LatticePlatform):
    device = "LIFCL-40"
    package = "BG400"
    speed = "8"
    default_clk = "clk12"
    ...
    resources = [
        ...
        Resource(
            "clk125", 0, Pins("C12", dir="i"), Clock(125e6), Attrs(IO_TYPE="LVDS")
        ),
        Resource(
            "i2c",
            0,
        ...
        *LEDResources(
            pins={8: "R17", 9: "R18", 10: "U20", 11: "T20", 12: "W20", 13: "V20"},
            invert=False,
            attrs=Attrs(IO_TYPE=bank2_iostandard),
        ),
        *ButtonResources(
            pins="G14 G15", invert=True, attrs=Attrs(IO_TYPE=bank1_iostandard)
        ),
        *SwitchResources(
            pins={
                0: "N14",
        ...
        UARTResource(
            0, rx="F16", tx="F18", attrs=Attrs(IO_TYPE=bank1_iostandard, PULLMODE="UP")
        ),
        *SPIFlashResources(
            0,
            cs_n="E13",
    ...
    connectors = [
        ...
        # PMOD signal number:
        #          1   2  3  4  7  8  9   10
        Connector("pmod", 0, "D10 D9 D7 D8 - - D6 D5 D4  D3 - -"),
        Connector("pmod", 1, "E10 E9 E7 E8 - - E4 E3 E2  F1"),
        Connector("pmod", 2, "J2  J1 K2 K1 - - K3 K4 D17 E18"),
        Connector(
            "fmc",
            0,
            {
