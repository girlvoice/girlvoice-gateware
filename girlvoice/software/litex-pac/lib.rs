...
impl crate :: Resettable for BusErrorsSpec { const RESET_VALUE : u32 = 0 ; } } } # [doc = "IDENTIFIER_MEM"]
...
# [doc = "Register block"]
pub struct RegisterBlock { identifier_mem : IdentifierMem , } impl RegisterBlock { # [doc = "0x00 - 8 x 52-bit memory"]
# [inline (always)]
pub const fn identifier_mem (& self) -> & IdentifierMem { & self . identifier_mem } } # [doc = "IDENTIFIER_MEM (rw) register accessor: 8 x 52-bit memory\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`identifier_mem::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`identifier_mem::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@identifier_mem`]
module"]
# [doc (alias = "IDENTIFIER_MEM")]
pub type IdentifierMem = crate :: Reg < identifier_mem :: IdentifierMemSpec > ; # [doc = "8 x 52-bit memory"]
...
impl crate :: Resettable for IdentifierMemSpec { const RESET_VALUE : u32 = 0 ; } } } # [doc = "LED_GPIO"]
pub struct LedGpio { _marker : PhantomData < * const () > } unsafe impl Send for LedGpio { } impl LedGpio { # [doc = r"Pointer to the register block"]
pub const PTR : * const led_gpio :: RegisterBlock = 0xf000_1000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const led_gpio :: RegisterBlock { Self :: PTR } # [doc = r" Steal an instance of this peripheral"]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Ensure that the new instance of the peripheral cannot be used in a way"]
...
# [doc = r" peripheral instance existing to ensure memory safety; ensure"]
# [doc = r" no stolen instances are passed to such software."]
pub unsafe fn steal () -> Self { Self { _marker : PhantomData } } } impl Deref for LedGpio { type Target = led_gpio :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * Self :: PTR } } } impl core :: fmt :: Debug for LedGpio { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("LedGpio") . finish () } } # [doc = "LED_GPIO"]
pub mod led_gpio { # [repr (C)]
# [doc = "Register block"]
pub struct RegisterBlock { out : Out , } impl RegisterBlock { # [doc = "0x00 - GPIO Output(s) Control."]
# [inline (always)]
pub const fn out (& self) -> & Out { & self . out } } # [doc = "OUT (rw) register accessor: GPIO Output(s) Control.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`out::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@out`]
module"]
# [doc (alias = "OUT")]
pub type Out = crate :: Reg < out :: OutSpec > ; # [doc = "GPIO Output(s) Control."]
pub mod out { # [doc = "Register `OUT` reader"]
pub type R = crate :: R < OutSpec > ; # [doc = "Register `OUT` writer"]
pub type W = crate :: W < OutSpec > ; # [doc = "Field `out` reader - "]
pub type OutR = crate :: BitReader ; # [doc = "Field `out` writer - "]
pub type OutW < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn out (& self) -> OutR { OutR :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn out (& mut self) -> OutW < OutSpec > { OutW :: new (self , 0) } } # [doc = "GPIO Output(s) Control.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`out::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OutSpec ; impl crate :: RegisterSpec for OutSpec { type Ux = u32 ; } # [doc = "`read()` method returns [`out::R`](R) reader structure"]
impl crate :: Readable for OutSpec { } # [doc = "`write(|w| ..)` method takes [`out::W`](W) writer structure"]
impl crate :: Writable for OutSpec { type Safety = crate :: Unsafe ; const ZERO_TO_MODIFY_FIELDS_BITMAP : u32 = 0 ; const ONE_TO_MODIFY_FIELDS_BITMAP : u32 = 0 ; } # [doc = "`reset()` method sets OUT to value 0"]
impl crate :: Resettable for OutSpec { const RESET_VALUE : u32 = 0 ; } } } # [doc = "TIMER0"]
...
impl crate :: Resettable for RxfullSpec { const RESET_VALUE : u32 = 0 ; } } } # [no_mangle]
...
pub identifier_mem : IdentifierMem , # [doc = "LED_GPIO"]
pub led_gpio : LedGpio , # [doc = "TIMER0"]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { ctrl : Ctrl { _marker : PhantomData } , identifier_mem : IdentifierMem { _marker : PhantomData } , led_gpio : LedGpio { _marker : PhantomData } , timer0 : Timer0 { _marker : PhantomData } , uart : Uart { _marker : PhantomData } , } } }